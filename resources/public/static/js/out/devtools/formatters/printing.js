...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22977){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22978,G__22979,seq22977__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22983_SHARP_){
return (!((cljs.core.meta.call(null,p1__22983_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__22984__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22988){var _e__22211__auto__ = e22988;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e22990){var _e__22211__auto__ = e22990;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22992 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22993 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22993);
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22992);
}});
...
var temp__5751__auto___22999 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___22999)){
var managed_print_level_23000 = temp__5751__auto___22999;
var _STAR_print_level_STAR__orig_val__22997_23001 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22998_23002 = managed_print_level_23000;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22998_23002);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__22996_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22996_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22997_23001);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1651858380068
