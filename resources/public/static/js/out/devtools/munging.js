...
var o22846 = temp__5751__auto__;
var temp__5751__auto____$1 = (o22846["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o22847 = temp__5751__auto____$1;
return (o22847["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22204__auto__ = f;
return (o__22204__auto__["toString"]).call(o__22204__auto__);
} else {
return "";
}
}catch (e22848){var _ = e22848;
return "";
}});
...
try{var o__22204__auto___22850 = t;
(o__22204__auto___22850["cljs$lang$ctorPrWriter"]).call(o__22204__auto___22850,t,writer);
}catch (e22849){var __22851 = e22849;
}
...
var char_code = (function (){var o__22204__auto__ = (new String(char$));
return (o__22204__auto__["charCodeAt"]).call(o__22204__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22204__auto__ = String;
return (o__22204__auto__["fromCharCode"]).call(o__22204__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22852 = num_code;
switch (G__22852) {
case (1):
return (185);
...
var o__22204__auto__ = String;
return (o__22204__auto__["fromCharCode"]).call(o__22204__auto__,superscript_code);
});
/**
...
}catch (e22854){var _e__22211__auto__ = e22854;
return false;
}})())){
...
var vec__22855 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22855,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o22858 = temp__5751__auto__;
var temp__5751__auto____$1 = (o22858["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o22859 = temp__5751__auto____$1;
return (o22859["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22862){
var vec__22863 = p__22862;
var ns_detector = cljs.core.nth.call(null,vec__22863,(0),null);
...
var G__22869 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22870 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22869;
remaining_tokens = G__22870;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22860){
var G__22861 = cljs.core.first.call(null,seq22860);
var seq22860__$1 = cljs.core.next.call(null,seq22860);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22861,seq22860__$1);
}));
...
var vec__22874 = cljs.core.split_with.call(null,(function (p1__22873_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22873_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22874,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22874,(1),null);
...
var vec__22880 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22880,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22880,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22883 = cljs.core.rest.call(null,remaining_tokens);
var G__22884 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22883;
name_tokens = G__22884;
continue;
} else {
...
var vec__22887 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22887,(0),null);
var arity = cljs.core.nth.call(null,vec__22887,(1),null);
var vec__22890 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22890,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22890,(1),null);
var vec__22893 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22893,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22893,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22893,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22893,(3),null);
...
var vec__22899 = result;
var munged_ns = cljs.core.nth.call(null,vec__22899,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22899,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22899,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22899,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22899,(4),null);
var arity = cljs.core.nth.call(null,vec__22899,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__22903 = temp__5751__auto__;
var munged_name = cljs.core.nth.call(null,vec__22903,(0),null);
var args = cljs.core.nth.call(null,vec__22903,(1),null);
var vec__22906 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22906,(0),null);
var name = cljs.core.nth.call(null,vec__22906,(1),null);
...
var G__22909 = (arity + (1));
var G__22910 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22911){
var vec__22912 = p__22911;
var arity = cljs.core.nth.call(null,vec__22912,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22912,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22915_SHARP_){
return cljs.core.get.call(null,arities,p1__22915_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22916_SHARP_){
return cljs.core.drop.call(null,(2),p1__22916_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22919){
var vec__22920 = p__22919;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22920,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22917){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22928__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22928__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22928__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22928__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22929 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22929,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22929,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22929,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22929,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22929,(4),null);
var arity = cljs.core.nth.call(null,vec__22929,(5),null);
...
var o__22204__auto__ = f;
return (o__22204__auto__["getBasis"]).call(o__22204__auto__);
});
/**
...
}catch (e22933){var _e__22211__auto__ = e22933;
...
var G__22934 = (obj[cljs.core.first.call(null,path)]);
var G__22935 = cljs.core.rest.call(null,path);
obj = G__22934;
path = G__22935;
continue;
} else {
...
var _STAR_ = (function (accum,p__22936){
var vec__22937 = p__22936;
var bit = cljs.core.nth.call(null,vec__22937,(0),null);
var protocol = cljs.core.nth.call(null,vec__22937,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22940){
var vec__22941 = p__22940;
var ns = cljs.core.nth.call(null,vec__22941,(0),null);
var name = cljs.core.nth.call(null,vec__22941,(1),null);
var selector = cljs.core.nth.call(null,vec__22941,(2),null);
...
var post_process = (function (p__22945){
var vec__22946 = p__22945;
var munged_name = cljs.core.nth.call(null,vec__22946,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22946,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22944_SHARP_){
return (obj[cljs.core.first.call(null,p1__22944_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1651858379718
