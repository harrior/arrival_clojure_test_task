...
}catch (e25357){var _e = e25357;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___25360 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___25360)){
var seen_errors_25361 = temp__5751__auto___25360;
if(cljs.core.truth_(seen_errors_25361.has(self))){
} else {
seen_errors_25361.add(self);

var temp__5753__auto___25362 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___25362)){
var sense_25363 = temp__5753__auto___25362;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25363)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1651858386538
