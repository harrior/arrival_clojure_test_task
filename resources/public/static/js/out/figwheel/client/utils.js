...
return (new CustomEvent(event_name,(function (){var obj28799 = ({"detail":data});
return obj28799;
})()));
} else {
...
var f = (function (){var pred__28806 = cljs.core._EQ_;
var expr__28807 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28806.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28807))){
return (function (p1__28800_SHARP_){
return console.warn(p1__28800_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28806.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28807))){
return (function (p1__28801_SHARP_){
return console.debug(p1__28801_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28806.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28807))){
return (function (p1__28802_SHARP_){
return console.error(p1__28802_SHARP_);
});
} else {
return (function (p1__28803_SHARP_){
return console.log(p1__28803_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28810){
...
var eval_fn = cljs.core.get.call(null,map__28811__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28813_SHARP_){
return new_def.callback(p1__28813_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28814){
var vec__28815 = p__28814;
var ky = cljs.core.nth.call(null,vec__28815,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1651858389459
