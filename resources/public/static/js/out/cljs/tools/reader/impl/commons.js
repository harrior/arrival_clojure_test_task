...
var G__24951 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24951;
continue;
} else {
return ch;
...
var vec__24952 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__24952,(0),null);
return (match === s);
});
...
var len__4736__auto___24957 = arguments.length;
var i__4737__auto___24958 = (0);
while(true){
if((i__4737__auto___24958 < len__4736__auto___24957)){
args__4742__auto__.push((arguments[i__4737__auto___24958]));

var G__24959 = (i__4737__auto___24958 + (1));
i__4737__auto___24958 = G__24959;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq24955){
...
return (function() { 
var G__24960__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__24960 = function (rdr,var_args){
var _ = null;
...
while (G__24961__i < G__24961__a.length) {G__24961__a[G__24961__i] = arguments[G__24961__i + 1]; ++G__24961__i;}
  _ = new cljs.core.IndexedSeq(G__24961__a,0,null);
} 
return G__24960__delegate.call(this,rdr,_);};
G__24960.cljs$lang$maxFixedArity = 1;
G__24960.cljs$lang$applyTo = (function (arglist__24962){
var rdr = cljs.core.first(arglist__24962);
var _ = cljs.core.rest(arglist__24962);
return G__24960__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1651858385143
