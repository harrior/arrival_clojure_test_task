...
var o22581 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22581["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22582 = temp__5718__auto____$1;
return (o22582["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21939__auto__ = f;
return (o__21939__auto__["toString"]).call(o__21939__auto__);
} else {
return "";
}
}catch (e22583){var _ = e22583;
return "";
}});
...
try{var o__21939__auto___22585 = t;
(o__21939__auto___22585["cljs$lang$ctorPrWriter"]).call(o__21939__auto___22585,t,writer);
}catch (e22584){var __22586 = e22584;
}
...
var char_code = (function (){var o__21939__auto__ = (new String(char$));
return (o__21939__auto__["charCodeAt"]).call(o__21939__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21939__auto__ = String;
return (o__21939__auto__["fromCharCode"]).call(o__21939__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22587 = num_code;
switch (G__22587) {
case (1):
return (185);
...
var o__21939__auto__ = String;
return (o__21939__auto__["fromCharCode"]).call(o__21939__auto__,superscript_code);
});
/**
...
}catch (e22589){var _e__21946__auto__ = e22589;
return false;
}})())){
...
var vec__22590 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22590,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22593 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22593["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22594 = temp__5718__auto____$1;
return (o22594["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22597){
var vec__22598 = p__22597;
var ns_detector = cljs.core.nth.call(null,vec__22598,(0),null);
...
var G__22604 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22605 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22604;
remaining_tokens = G__22605;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22595){
var G__22596 = cljs.core.first.call(null,seq22595);
var seq22595__$1 = cljs.core.next.call(null,seq22595);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22596,seq22595__$1);
}));
...
var vec__22609 = cljs.core.split_with.call(null,(function (p1__22608_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22608_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22609,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22609,(1),null);
...
var vec__22615 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22615,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22615,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22618 = cljs.core.rest.call(null,remaining_tokens);
var G__22619 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22618;
name_tokens = G__22619;
continue;
} else {
...
var vec__22622 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22622,(0),null);
var arity = cljs.core.nth.call(null,vec__22622,(1),null);
var vec__22625 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22625,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22625,(1),null);
var vec__22628 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22628,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22628,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22628,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22628,(3),null);
...
var vec__22634 = result;
var munged_ns = cljs.core.nth.call(null,vec__22634,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22634,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22634,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22634,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22634,(4),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22638 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22638,(0),null);
var args = cljs.core.nth.call(null,vec__22638,(1),null);
var vec__22641 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22641,(0),null);
var name = cljs.core.nth.call(null,vec__22641,(1),null);
...
var G__22644 = (arity + (1));
var G__22645 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22646){
var vec__22647 = p__22646;
var arity = cljs.core.nth.call(null,vec__22647,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22647,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22650_SHARP_){
return cljs.core.get.call(null,arities,p1__22650_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22651_SHARP_){
return cljs.core.drop.call(null,(2),p1__22651_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22658 = arguments.length;
var i__4737__auto___22659 = (0);
while(true){
if((i__4737__auto___22659 < len__4736__auto___22658)){
args__4742__auto__.push((arguments[i__4737__auto___22659]));

var G__22660 = (i__4737__auto___22659 + (1));
i__4737__auto___22659 = G__22660;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22654){
var vec__22655 = p__22654;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22655,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22652){
var G__22653 = cljs.core.first.call(null,seq22652);
var seq22652__$1 = cljs.core.next.call(null,seq22652);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22653,seq22652__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22663__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22663__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22663__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22663__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22664 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22664,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22664,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22664,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22664,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22664,(4),null);
var arity = cljs.core.nth.call(null,vec__22664,(5),null);
...
var o__21939__auto__ = f;
return (o__21939__auto__["getBasis"]).call(o__21939__auto__);
});
/**
...
}catch (e22668){var _e__21946__auto__ = e22668;
...
var G__22669 = (obj[cljs.core.first.call(null,path)]);
var G__22670 = cljs.core.rest.call(null,path);
obj = G__22669;
path = G__22670;
continue;
} else {
...
var _STAR_ = (function (accum,p__22671){
var vec__22672 = p__22671;
var bit = cljs.core.nth.call(null,vec__22672,(0),null);
var protocol = cljs.core.nth.call(null,vec__22672,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22675){
var vec__22676 = p__22675;
var ns = cljs.core.nth.call(null,vec__22676,(0),null);
var name = cljs.core.nth.call(null,vec__22676,(1),null);
var selector = cljs.core.nth.call(null,vec__22676,(2),null);
...
var post_process = (function (p__22680){
var vec__22681 = p__22680;
var munged_name = cljs.core.nth.call(null,vec__22681,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22681,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22679_SHARP_){
return (obj[cljs.core.first.call(null,p1__22679_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1651769142594
