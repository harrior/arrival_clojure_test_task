...
if(cljs.core.truth_(reagenttest.core.on_js_reload)){
return cljs.core.apply.call(null,reagenttest.core.on_js_reload,x__31024__auto__);
} else {
return figwheel.client.utils.log.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),["Figwheel: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"on-jsload","on-jsload",-395756602))," hook '","reagenttest.core/on-js-reload","' is missing"].join(''));
}
};
...
//# sourceMappingURL=connect.js.map?rel=1651769156512
