...
var G__24753 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24753;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24754 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24754,ch);
...
if(("\\" === ch__$1)){
var ch_24755__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24755__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24755__$2);
} else {
}

var G__24756 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24756;
continue;
}
}
...
var vec__24764 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24764,(0),null);
var start_column = cljs.core.nth.call(null,vec__24764,(1),null);
...
var G__24767 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24767;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24768 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24769 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24769);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24768);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24770 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24770,(0),null);
var start_column = cljs.core.nth.call(null,vec__24770,(1),null);
...
var vec__24773 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24773,(0),null);
var end_column = cljs.core.nth.call(null,vec__24773,(1),null);
...
var vec__24776 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__24779 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24779,(0),null);
var end_column = cljs.core.nth.call(null,vec__24779,(1),null);
...
var vec__24782 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var sb = (function (){var G__24788 = (new goog.string.StringBuffer());
G__24788.append(initch);
...
var G__24790 = (function (){var G__24789 = sb;
G__24789.append(ch);

return G__24789;
})();
var G__24791 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24790;
ch = G__24791;
continue;
}
...
switch (G__24794) {
case "\\":
var G__24798 = (function (){var G__24795 = sb;
G__24795.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24795;
})();
var G__24799 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24798;
ch = G__24799;
continue;
...
break;
default:
var G__24800 = (function (){var G__24796 = sb;
G__24796.append(ch);

return G__24796;
})();
var G__24801 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24800;
ch = G__24801;
continue;
...
var vec__24802 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24802,(0),null);
var end_column = cljs.core.nth.call(null,vec__24802,(1),null);
...
var vec__24805 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24805,(0),null);
var column = cljs.core.nth.call(null,vec__24805,(1),null);
...
var vec__24820 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24820,(0),null);
var start_column = cljs.core.nth.call(null,vec__24820,(1),null);
...
var vec__24823 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24823,(0),null);
var end_column = cljs.core.nth.call(null,vec__24823,(1),null);
...
var G__24826 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24826,true,null,opts,pending_forms);
...
var G__24827 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24827)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24827)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24827)){
...
var _STAR_suppress_read_STAR__orig_val__24828 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24829 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24829);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24828);
}});
...
var G__24830 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24830,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24830,rdr,first_line);
...
var G__24834 = matched;
var G__24835 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24834;
finished = G__24835;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24836 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24837 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24837);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24836);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24838 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24839 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__24839);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24840 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24840,"(");
...
var G__24841 = (i + (1));
var G__24842 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__24838);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24843 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24843);
...
var G__24844 = cljs.core.next.call(null,s__$1);
var G__24845 = ret;
s__$1 = G__24844;
r = G__24845;
continue;
...
var G__24846 = cljs.core.next.call(null,s);
var G__24847 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24846;
key_vals = G__24847;
continue;
} else {
...
var gensym_env_orig_val__24852 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24853 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__24853);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__24852);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24854 = token;
var G__24854__$1 = (((G__24854 == null))?null:cljs.core.subs.call(null,G__24854,(1)));
var G__24854__$2 = (((G__24854__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24854__$1));
var G__24854__$3 = (((G__24854__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24854__$2));
var G__24854__$4 = (((G__24854__$3 == null))?null:cljs.core.symbol.call(null,G__24854__$3));
if((G__24854__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24854__$4);
}
})():(function (){var G__24855 = token;
var G__24855__$1 = (((G__24855 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24855));
if((G__24855__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24855__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24866,reader){
var map__24867 = p__24866;
var map__24867__$1 = (((((!((map__24867 == null))))?(((((map__24867.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24867.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24867):map__24867);
var opts = map__24867__$1;
var eof = cljs.core.get.call(null,map__24867__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1651769148755
