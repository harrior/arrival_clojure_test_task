...
return cljs.core.reduce.call(null,(function (result,p__24029){
...
var vec__24033 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24033,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24033,(1),null);
var ab = cljs.core.nth.call(null,vec__24033,(2),null);
...
return clojure$data$EqualityPartition$equality_partition$dyn_24039.call(null,x);
}
});
...
return clojure$data$Diff$diff_similar$dyn_24040.call(null,a,b);
}
});
...
return (function (){var G__24044 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24044__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1651769145982
